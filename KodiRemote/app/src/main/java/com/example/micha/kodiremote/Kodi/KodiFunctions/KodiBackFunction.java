...
public class KodiBackFunction implements IKodi {
        private String id;
        private String method;
        private String jsonrpc;
        private transient KodiParameters kp;

    public KodiBackFunction(KodiParameters kp) {
        this.kp=kp;
        this.setId("1");
        this.setJsonrpc("2.0");
        this.setMethod("Input.Back");
        Params param = new Params();
        param.setPlayerid(0);
    }

    public KodiBackFunction(String id, String jsonrpc, String method) {
        this.setId(id);

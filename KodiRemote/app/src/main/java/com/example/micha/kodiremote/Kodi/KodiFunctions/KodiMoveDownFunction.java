...
public class KodiMoveDownFunction implements IKodi {
        private String id;
        private String method;
        private String jsonrpc;
        private transient KodiParameters kp;

    public KodiMoveDownFunction(KodiParameters kp) {
        this.kp=kp;
        this.setId("1");
        this.setJsonrpc("2.0");
        this.setMethod("Input.Down");
        Params param = new Params();
        param.setPlayerid(0);
    }

    public KodiMoveDownFunction(String id, String jsonrpc, String method) {
        this.setId(id);

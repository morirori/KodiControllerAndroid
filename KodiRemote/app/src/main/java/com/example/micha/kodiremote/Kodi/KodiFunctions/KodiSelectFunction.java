...
public class KodiSelectFunction implements IKodi {
        private String id;
        private String method;
        private String jsonrpc;
        private transient KodiParameters kp;

    public KodiSelectFunction(KodiParameters kp) {
        this.kp=kp;
        this.setId("1");
        this.setJsonrpc("2.0");
        this.setMethod("Input.Select");
        Params param = new Params();
        param.setPlayerid(0);
    }

    public KodiSelectFunction(String id, String jsonrpc, String method) {
        this.setId(id);
